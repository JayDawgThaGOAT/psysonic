export const player = {
  ...
  sourceFailureTitle: 'No se pudo reproducir {{title}}',
  sourceFailureBody: 'La fuente en cola no se modificó. Elige otra copia disponible para intentarlo de nuevo.',
  sourceFailureDetail: 'Error de reproducción: {{detail}}',
  sourceFailureSearching: 'Buscando otra fuente seleccionada…',
  sourceFailureLoadError: 'No se pudieron comprobar las fuentes alternativas.',
  sourceFailureNone: 'No hay ninguna alternativa reproducible en los servidores seleccionados.',
  sourceFailurePlayError: 'No se pudo cargar esa fuente. La cola no se modificó.',
  sourceFailurePlayFrom: 'Reproducir desde {{server}}',
  sourceFailureLocal: 'Descargado',
  sourceFailureOnline: 'En línea',
  sourceFailureSwitching: 'Cambiando…',
  sourceFailureKeep: 'Mantener la fuente actual',
};
