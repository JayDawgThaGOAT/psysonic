export const player = {
  ...
  sourceFailureTitle: 'Не удалось воспроизвести {{title}}',
  sourceFailureBody: 'Источник в очереди не изменён. Выберите другую доступную копию.',
  sourceFailureDetail: 'Ошибка воспроизведения: {{detail}}',
  sourceFailureSearching: 'Поиск другого выбранного источника…',
  sourceFailureLoadError: 'Не удалось проверить альтернативные источники.',
  sourceFailureNone: 'На выбранных серверах нет доступной для воспроизведения альтернативы.',
  sourceFailurePlayError: 'Не удалось загрузить этот источник. Очередь не изменена.',
  sourceFailurePlayFrom: 'Воспроизвести с {{server}}',
  sourceFailureLocal: 'Загружено',
  sourceFailureOnline: 'В сети',
  sourceFailureSwitching: 'Переключение…',
  sourceFailureKeep: 'Оставить текущий источник',
};
