export const player = {
  ...
  sourceFailureBody: 'The queued source was left unchanged. Choose another available copy to try again.',
  sourceFailureDetail: 'Playback error: {{detail}}',
  sourceFailureSearching: 'Looking for another selected source…',
  sourceFailureLoadError: 'Couldn’t check alternative sources.',
  sourceFailureNone: 'No playable alternative is available from the selected servers.',
  sourceFailurePlayError: 'Couldn’t load that source. The queue was not changed.',
  sourceFailurePlayFrom: 'Play from {{server}}',
  sourceFailureLocal: 'Downloaded',
  sourceFailureOnline: 'Online',
  sourceFailureSwitching: 'Switching…',
  sourceFailureKeep: 'Keep current source',
};
